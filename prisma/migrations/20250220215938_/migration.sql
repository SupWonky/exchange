...
INSERT INTO "new_Service" ("averageRating", "categoryId", "createdAt", "deletedAt", "id", "slug", "status", "title", "totalReviews", "updatedAt", "userId") SELECT "averageRating", "categoryId", "createdAt", "deletedAt", "id", "slug", "status", "title", "totalReviews", "updatedAt", "userId" FROM "Service";
DROP TABLE "Service";
